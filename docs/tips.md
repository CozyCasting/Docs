...
- **`/fishinfo <code>` before selling** — Double-check a fish's value before committing. Trait stacking can make a fish worth far more than it looks.
- **Vote for free cooldown skips** — Vote Tickets from voting let you fish immediately. Useful when you're in a grinding session.
...
| Situation | Best Bait |
|-----------|-----------|
| Casual fishing, any location | Earthworm (free from Bait Bin) |
| River / Lake grinding | Cricket or Minnow |
| Ocean / Deep Sea grinding | Shrimp or Squid |
| Chasing Legendary+ anywhere | Magic Bait |
| Long sessions (25 casts) | Golden Lure |

!!! tip "Bait Bin tip"
    At camp level 5, the Bait Bin produces up to 5 bait per cycle (2 hours). Collect regularly and you'll rarely need to buy Earthworms again.
